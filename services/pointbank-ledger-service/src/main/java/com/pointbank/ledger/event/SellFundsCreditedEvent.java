...
public record SellFundsCreditedEvent(
        ...
        long quantity, long orderPrice, long orderAmount, long fee, long tax,
        long totalAmount, LocalDateTime quoteObservedAt,
        String ledgerRequestNo, long cashBalanceAfter
) {
}
